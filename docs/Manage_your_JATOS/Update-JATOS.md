...
For example, if the version you want to update to is `v3.10.1` (don't forget the 'v') and your domain is `my.jatos.org`, then the URL for your browser is:

```
https://my.jatos.org/jatos/admin?version=v3.10.1
```
