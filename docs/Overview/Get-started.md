...
1. **Download and import an example study**
   ...
   1. Import the study into JATOS: Go to JATOS' GUI in your browser and click on **Import Study** in the header. Choose the [_.jzip_](JATOS-Study-Archive-JZIP.html) (or _.zip_) file you just downloaded. The imported study should appear in the sidebar on the left.
