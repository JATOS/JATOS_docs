...
The API is work in progress. To request any additional endpoints, please write a [GitHub issue](https://github.com/JATOS/JATOS/issues).
...
Go to the user menu (click on your name in the top-right header). Then click the button _My API tokens_.
