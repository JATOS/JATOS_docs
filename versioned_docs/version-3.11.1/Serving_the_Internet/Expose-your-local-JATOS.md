...
Some general advice:
* This is the easiest way to bring JATOS online, but also the **least reliable**. Your local computer is prone to accidents (e.g., unplugged power cable, interrupted Internet). If you need a more dependable JATOS, see [Bring your JATOS online](Bring-your-JATOS-online).
...
* For more reliable options, see [ways to bring your JATOS online](Bring-your-JATOS-online).
...
5. Copy and paste the URL with _https_ into your browser and check that JATOS is running properly using JATOS' built-in [tests](/Troubleshooting#jatos-test-page).
6. That's it! Now you can [add study links](Run-your-Study-with-Study-Links) and send them to your participants. Remember to use the _ngrok.io_ address (not your localhost address) when sharing study links.
...
2. In your terminal, execute:
   ...
   ```
3. Copy and paste the URL with _https_ into your browser and check that JATOS is running properly using JATOS' built-in [tests](/Troubleshooting#jatos-test-page).
4. That's it! Now you can [add study links](Run-your-Study-with-Study-Links) and send them to your participants. Remember to use the _localhost.run_ address (not your localhost address) when sharing study links.
